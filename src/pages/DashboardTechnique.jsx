...
const DashboardTechnique = ({ user }) => {
  ...
  const [showStockReel, setShowStockReel] = useState(false);
  const [showTableauxBord, setShowTableauxBord] = useState(false);
  const [showGestionUsers, setShowGestionUsers] = useState(false);
  ...
  const styles = {
    ...
    sidebarBtnPrimary: {
      ...
      cursor: 'pointer',
      transition: 'all 0.2s ease',
      boxShadow: '0 6px 20px rgba(9, 105, 218, 0.35)',
      width: '100%',
    },
    btnIcon: {
      width: '38px',
    ...
    btnContent: { flex: '1' },
    btnTitle: { fontSize: '14px', fontWeight: '600', marginBottom: '3px', color: '#24292e' },
    btnTitlePrimary: { fontSize: '14px', fontWeight: '700', marginBottom: '3px', color: '#fff' },
    btnSubtitle: { fontSize: '12px', color: '#6e7681', fontWeight: '500' },
    ...
    kpiCardPrimary: {
      background: 'linear-gradient(135deg, #0969da 0%, #0550ae 100%)',
      border: 'none',
      boxShadow: '0 8px 24px rgba(9, 105, 218, 0.3)',
    },
    kpiLabel: { fontSize: '12px', color: '#6e7681', margin: '0 0 14px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px' },
    ...
    kpiValue: { fontSize: '36px', fontWeight: '800', margin: '0', color: '#24292e', letterSpacing: '-1.5px' },
    ...
    card: { background: '#fff', borderRadius: '16px', border: '1px solid #e1e4e8', padding: '2rem', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)' },
    cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.75rem', paddingBottom: '1.25rem', borderBottom: '2px solid #f6f8fa' },
    cardTitle: { fontSize: '19px', fontWeight: '700', margin: '0', color: '#24292e' },
    btnLink: { 
      fontSize: '13px', 
      padding: '10px 18px', 
      background: '#f6f8fa', 
    ...
    th: { textAlign: 'left', padding: '14px 10px', fontWeight: '700', color: '#6e7681', borderBottom: '2px solid #e1e4e8', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.6px', background: '#f6f8fa' },
    thRight: { textAlign: 'right', padding: '14px 10px', fontWeight: '700', color: '#6e7681', borderBottom: '2px solid #e1e4e8', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.6px', background: '#f6f8fa' },
    td: { padding: '16px 10px', borderBottom: '1px solid #e1e4e8' },
    tdMuted: { padding: '16px 10px', borderBottom: '1px solid #e1e4e8', color: '#6e7681', fontSize: '13px', fontWeight: '500' },
    tdBold: { padding: '16px 10px', borderBottom: '1px solid #e1e4e8', fontWeight: '700', color: '#24292e' },
    tdRight: { padding: '16px 10px', borderBottom: '1px solid #e1e4e8', textAlign: 'right', fontWeight: '700' },
    tdRightSuccess: { padding: '16px 10px', borderBottom: '1px solid #e1e4e8', textAlign: 'right', fontWeight: '700', color: '#1a7f37' },
    tdRightDanger: { padding: '16px 10px', borderBottom: '1px solid #e1e4e8', textAlign: 'right', fontWeight: '700', color: '#cf222e' },
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.titleSection}>
          ...
          <div style={styles.titleContent}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <h1 style={styles.title}>Tableau de Bord Technique</h1>
              <span style={styles.roleBadge}>Directeur Technique</span>
            </div>
        ...
        <div style={styles.headerActions}>
          ...
          <div style={styles.userAvatar}
            ...
            {user?.nom ? user.nom.substring(0, 2).toUpperCase() : 'DT'}
          </div>
        </div>
      </div>
          ...
          <div style={styles.sidebar}>
            <div style={styles.sidebarSection}>
              ...
              <button type="button"
                ...
                onClick={() => { setActiveSection('stock'); setShowStockReel(true); }}
                onMouseOver={(e) => { if (activeSection === 'stock') { e.currentTarget.style.transform = 'translateY(-2px)'; } else { e.currentTarget.style.background = '#f6f8fa'; } }}
              ...
              <button type="button"
                ...
                onMouseOver={(e) => { if (activeSection === 'historique') { e.currentTarget.style.transform = 'translateY(-2px)'; } else { e.currentTarget.style.background = '#f6f8fa'; } }}
              ...
              <button type="button"
                ...
                onMouseOver={(e) => { if (activeSection === 'recherche') { e.currentTarget.style.transform = 'translateY(-2px)'; } else { e.currentTarget.style.background = '#f6f8fa'; } }}
              ...
              <button type="button"
                ...
                onMouseOver={(e) => { if (activeSection === 'stock-produits') { e.currentTarget.style.transform = 'translateY(-2px)'; } else { e.currentTarget.style.background = '#f6f8fa'; } }}
            ...
            <div style={styles.sidebarSection}>
              ...
              <button type="button"
                style={activeSection === 'users' ? styles.sidebarBtnPrimary : styles.sidebarBtn}
                onClick={() => { setActiveSection('users'); setShowGestionUsers(true); }}
                onMouseOver={(e) => { if (activeSection === 'users') { e.currentTarget.style.transform = 'translateY(-2px)'; } else { e.currentTarget.style.background = '#f6f8fa'; } }}
                onMouseOut={(e) => { if (activeSection === 'users') { e.currentTarget.style.transform = 'translateY(0)'; } else { e.currentTarget.style.background = 'transparent'; } }}>
                <div style={activeSection === 'users' ? styles.btnIcon : styles.btnIconSecondary}>👥</div>
                <div style={styles.btnContent}>
                  <div style={activeSection === 'users' ? styles.btnTitlePrimary : styles.btnTitle}>Gestion Utilisateurs</div>
                  <div style={activeSection === 'users' ? styles.btnSubtitlePrimary : styles.btnSubtitle}>Ajouter/Modifier/Supprimer</div>
                </div>
              </button>
            </div>
          </div>
          ...
          <div style={styles.mainContent}>
            <div style={styles.kpiGrid}>
              ...
              <div style={{...styles.kpiCard, ...styles.kpiCardPrimary}}
                onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 16px 36px rgba(9, 105, 218, 0.45)'; }}
                onMouseOut={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(9, 105, 218, 0.3)'; }}>
            ...
            <div style={styles.card}>
              ...
              <div style={styles.alertsList}>
                {kpis.loading ? (
                  <div style={{ textAlign: 'center', padding: '2rem', color: '#6e7681' }}>⏳ Chargement des alertes...</div>
            ...
            <div style={styles.card}>
              ...
              <div style={styles.tableContainer}>
                {kpis.loading ? (
                  <div style={{ textAlign: 'center', padding: '2rem', color: '#6e7681' }}>⏳ Chargement...</div>
                ) : kpis.derniersMovements.length === 0 ? (
                  <div style={{ textAlign: 'center', padding: '2rem', color: '#6e7681' }}>Aucun mouvement récent</div>
                ) : (
      ...
      {showGestionUsers && <GestionUtilisateurs onClose={() => setShowGestionUsers(false)} />}
                ...
                <div style={styles.alertsList}>
                  {kpis.alertesDetails.map((alert, i) => (
                    <div key={i} style={styles.alertItem}
                      ...
                      <div>
                        <p style={styles.alertRef}>Ref: {alert.reference}</p>
                        <p style={{...styles.alertLocation, marginTop: '5px'}}>
                          {alert.designation}
                        </p>
                        <p style={styles.alertLocation}>📍 {alert.emplacement}</p>
                      </div>
      ...
      {showRechercheSpecifique && (
        <div style={{
          ...
          zIndex: 1000,
          backdropFilter: 'blur(4px)',
        }} onClick={() => setShowRechercheSpecifique(false)}>
          <div style={{
            background: '#fff',
            borderRadius: '16px',
            width: '90%',
              ...
              {!resultatsRecherche ? (
                <div style={{ textAlign: 'center', padding: '4rem', color: '#6e7681' }}>
                  ...
                  <p style={{ fontSize: '16px', fontWeight: '600' }}>
                    Entrez une référence pour rechercher
                  </p>
                </div>
              ) : !resultatsRecherche.found ? (
                <div style={{ textAlign: 'center', padding: '4rem', color: '#dc2626' }}>
                  <div style={{ fontSize: '64px', marginBottom: '1rem' }}>❌</div>
                  <p style={{ fontSize: '18px', fontWeight: '700', marginBottom: '0.5rem' }}>
                    Produit non trouvé
                  </p>
                  <p style={{ color: '#6e7681' }}>
                    Aucun mouvement pour la référence "{referenceRecherche}"
                  </p>
                </div>
              ) : (
                <div>
                  <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        <p style={{ fontSize: '13px', color: '#6e7681', fontWeight: '700', textTransform: 'uppercase', marginBottom: '8px' }}>
                          Référence
                        </p>
                        <p style={{ fontSize: '24px', fontWeight: '800', color: '#24292e', margin: 0 }}>
                          {resultatsRecherche.produit.reference}
                        </p>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <p style={{ fontSize: '16px', fontWeight: '600', color: '#24292e', margin: 0 }}>
                          {resultatsRecherche.produit.designation}
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        {resultatsRecherche.operations.map((op, i) => (
                          <tr key={i} style={{ transition: 'background 0.2s ease' }}
                            ...
                            <td style={{
                              ...
                              fontWeight: '800',
                              fontSize: '22px',
                              color: op.stock < 100 ? '#dc2626' : op.stock < 500 ? '#d97706' : '#1a7f37',
                            }}>
      ...
      {showStockProduitsFinis && (
        <div style={{
          ...
          zIndex: 1000,
          backdropFilter: 'blur(4px)',
        }} onClick={() => setShowStockProduitsFinis(false)}>
          <div style={{
            background: '#fff',
            borderRadius: '16px',
            width: '95%',
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6e7681', margin: 0, fontWeight: '500' }}>
                  Liste complète triée par quantité • 
                  <span style={{ 
                    color: '#dc2626', 
                    fontWeight: '700',
                    marginLeft: '8px',
                  }}>
                    ⚠️ Rouge si &gt; 10000 pièces
                  </span>
                </p>
              </div>
              <button
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '12px', color: '#6e7681', fontWeight: '700', textTransform: 'uppercase', marginBottom: '8px' }}>
                  Total Produits
                </div>
                <div style={{ fontSize: '28px', fontWeight: '800', color: '#24292e' }}>
                  {stockProduits.length}
                </div>
              </div>
              <div style={{
                background: '#fff',
                ...
                <div style={{ fontSize: '28px', fontWeight: '800', color: '#0969da' }}>
                  {stockProduits.reduce((sum, p) => sum + p.stock, 0).toLocaleString()}
                </div>
              </div>
              <div style={{
                background: '#fff5f5',
                ...
                <div style={{ fontSize: '12px', color: '#991b1b', fontWeight: '700', textTransform: 'uppercase', marginBottom: '8px' }}>
                  Alertes (&gt; 10000)
                </div>
                <div style={{ fontSize: '28px', fontWeight: '800', color: '#dc2626' }}>
                  {stockProduits.filter(p => p.stock > 10000).length}
                </div>
              </div>
            </div>
            ...
            <div style={{ flex: 1, overflow: 'auto' }}>
              {loadingStockProduits ? (
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead style={{ position: 'sticky', top: 0, background: '#f6f8fa', zIndex: 10 }}>
                    <tr>
                      <th style={{
                        padding: '16px 24px',
                        textAlign: 'left',
                  ...
                  <tbody>
                    {stockProduits.map((produit, index) => {
                      ...
                      return (
                        <tr key={produit.reference}
                          style={{
                            background: isAlerte ? '#fff5f5' : 'transparent',
                            transition: 'all 0.2s ease',
                          }}
                          onMouseOver={(e) => {
                            e.currentTarget.style.background = isAlerte ? '#fee2e2' : '#f6f8fa';
                          }}
                          onMouseOut={(e) => {
                            e.currentTarget.style.background = isAlerte ? '#fff5f5' : 'transparent';
                          }}
                        >
                          <td style={{
                            padding: '18px 24px',
                          ...
                          <td style={{
                            ...
                            borderBottom: '1px solid #e1e4e8',
                            fontSize: '14px',
                            color: isAlerte ? '#991b1b' : '#24292e',
                            fontWeight: isAlerte ? '600' : '500',
                          }}>
                            {produit.designation}
                          </td>
                          <td style={{
