            ...
            <table style={styles.table}>
              ...
              <tbody>
                {utilisateurs.map((user) => {
                  ...
                  return (
                    <tr key={user.id_user} style={{ transition: 'background 0.2s ease' }}
                    ...
                    >
                      ...
                      <td style={{...styles.td, color: '#6e7681'}}>
                        {user.email}
                      </td>
                      <td style={styles.td}>
                        <span style={{
                      ...
                      <td style={styles.td}>
                        <span style={{
                          ...styles.badge,
                          background: user.actif ? '#dcfce7' : '#fee2e2',
                          color: user.actif ? '#166534' : '#991b1b',
                        }}>
